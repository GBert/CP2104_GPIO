...
{
 uint32_t argn = strtoul(args, ((void *)0), 0);
...
{
 char p = (__extension__ ({ int __res; if (sizeof ((int)args[0]) > 1) { if (__builtin_constant_p ((int)args[0])) { int __c = ((int)args[0]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper ((int)args[0]); } else __res = (*__ctype_toupper_loc ())[(int) ((int)args[0])]; __res; }));
...
{
 struct k8048 k;
 char *execdup = ((void *)0), *execname = ((void *)0);
 ...
 if (strcasecmp(argv[1], "LED") == 0)
 {
  ...
  do {
   err = io_test_command(&k, k.fwsleep, k.fwsleep << 1, cmd, 1, ((void *)0), 0);
   ...
   if (err != (0)) {
    ...
    io_usleep(&k, (256) * k.fwsleep);
   }
  } while (!io_stop && err != (0) && err != (4));
 }
 ...
 else if (strcasecmp(argv[1], "SLEEP") == 0)
 {
  ...
  cmd[0] = (0x10);
  do {
   err = io_test_command(&k, k.fwsleep, k.fwsleep << 1, cmd, 0, ((void *)0), 0);
   fprintf(stderr, "0x%02X() = 0x%02X\n",
    cmd[0], err);
   if (err != (0)) {
    if (k.debug >= 1) {
 ...
 else if (strcasecmp(argv[1], "DIRECTION") == 0)
 {
  ...
  cmd[0] = (0x20);
  cmd[1] = getportarg(&k, execname, argv[2]);
  cmd[2] = getbytearg(&k, execname, argv[3]);
  do {
   err = io_test_command(&k, k.fwsleep, k.fwsleep << 1, cmd, 2, ((void *)0), 0);
 ...
 else if (strcasecmp(argv[1], "SAMPLE") == 0)
 {
  ...
  do {
   sample = 0;
   err = io_test_command(&k, k.fwsleep, (200), cmd, 0, &sample, 2);
   fprintf(stderr, "0x%02X() = 0x%02X\n",
    cmd[0], err);
   if (err != (0)) {
    if (k.debug >= 1) {
 ...
 else if (strcasecmp(argv[1], "EEWRITE") == 0)
 {
  ...
  cmd[2] = getbytearg(&k, execname, argv[3]);
  do {
   err = io_test_command(&k, k.fwsleep, (200), cmd, 2, ((void *)0), 0);
   fprintf(stderr, "0x%02X(0x%02X, 0x%02X) = 0x%02X\n",
    cmd[0], cmd[1], cmd[2], err);
   if (err != (0)) {
    if (k.debug >= 1) {
  ...
  uint32_t data;
  uint16_t addr = getshortarg(&k, execname, argv[2]);
 ...
 else if (strcasecmp(argv[1], "16") == 0)
 {
  ...
  uint32_t in = 0;
  uint16_t fwarg = getshortarg(&k, execname, argv[2]);
 ...
 else if (strcasecmp(argv[1], "24") == 0)
 {
  ...
  uint32_t in = 0;
  uint32_t fwarg = get24arg(&k, execname, argv[2]);
 ...
 else if (strcasecmp(argv[1], "32") == 0)
 {
  ...
  uint32_t in = 0;
  uint32_t fwarg = getintarg(&k, execname, argv[2]);
