...
main(int argc, char **argv)
{
 ...
 execname = __xpg_basename(execdup);
 if (execname == ((void *)0)) {
 ...
 if (strcmp(execname, "ktest") == 0) {
  ...
  int32_t testarg = strtol(argv[2], ((void *)0), 0);
  if (testarg < 0)
  ...
  if (strcasecmp(argv[1], "VPP") == 0)
   ...
   int32_t test = strtol(argv[1], ((void *)0), 0);
   switch (test) {
 ...
 int argv1 = (__extension__ ({ int __res; if (sizeof ((int)argv[1][0]) > 1) { if (__builtin_constant_p ((int)argv[1][0])) { int __c = ((int)argv[1][0]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower ((int)argv[1][0]); } else __res = (*__ctype_tolower_loc ())[(int) ((int)argv[1][0])]; __res; }));
 if (argv1 == 's') {
  if (argc < 3) {
   pic_selector(&k);
   io_exit(&k, 0);
  ...
  if (mystrcasestr(argv[2], "dspic") == argv[2]) {
   strncpy(k.devicename, argv[2], (1024));
  } else if (mystrcasestr(argv[2], "pic") == argv[2]) {
   strncpy(k.devicename, argv[2], (1024));
  } else {
   int32_t temp = strtol(argv[2], ((void *)0), 0);
   if (temp < 10 || temp > 33) {
    usage(&k, execname, "Invalid arg [select]");
   }
   if (temp == 30 || temp == 33) {
    strcpy(k.devicename, "dspic");
    strncpy(&k.devicename[5], argv[2], (1024) - 5);
   } else {
    strcpy(k.devicename, "pic");
    strncpy(&k.devicename[3], argv[2], (1024) - 3);
   }
  }
  argc -= 2;
  argv += 2;
  if (argc < 2)
   usage(&k, execname, "Missing arg(s)");
 } else if (k.pic->arch == (0x00000FFF)) {
  usage(&k, execname, "Missing select");
 }


 argv1 = (__extension__ ({ int __res; if (sizeof ((int)argv[1][0]) > 1) { if (__builtin_constant_p ((int)argv[1][0])) { int __c = ((int)argv[1][0]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower ((int)argv[1][0]); } else __res = (*__ctype_tolower_loc ())[(int) ((int)argv[1][0])]; __res; }));
 if (argv1 == 'l') {
  if (k.pic->arch == (0x00000FFF)) {
  ...
  if (k.pic->arch == (0x00000FFF) || k.pic->arch == (0x00003FFF) || k.pic->arch == (0xFFFFFFFF)) {
 ...
 argv1 = (__extension__ ({ int __res; if (sizeof ((int)argv[1][0]) > 1) { if (__builtin_constant_p ((int)argv[1][0])) { int __c = ((int)argv[1][0]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower ((int)argv[1][0]); } else __res = (*__ctype_tolower_loc ())[(int) ((int)argv[1][0])]; __res; }));
 int argv11 = (__extension__ ({ int __res; if (sizeof ((int)argv[1][1]) > 1) { if (__builtin_constant_p ((int)argv[1][1])) { int __c = ((int)argv[1][1]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower ((int)argv[1][1]); } else __res = (*__ctype_tolower_loc ())[(int) ((int)argv[1][1])]; __res; }));
 switch (argv1) {
 case 'b': if (argc > 2)
 ...
 case 'c': if (argc > 3)
   ...
   if (argc == 2)
    ...
    pic_writebandgap(&k, strtoul(argv[2], ((void *)0), 0));
   break;
 ...
 case 'e': if (argv11 == 'r') {
    ...
    char prompt[(1024)] = {0}, *endptr = ((void *)0);
    ...
    int argv2 = (__extension__ ({ int __res; if (sizeof ((int)argv[2][0]) > 1) { if (__builtin_constant_p ((int)argv[2][0])) { int __c = ((int)argv[2][0]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower ((int)argv[2][0]); } else __res = (*__ctype_tolower_loc ())[(int) ((int)argv[2][0])]; __res; }));
    switch (argv2) {
    case 'i':
    case 'u':
     row = ((4294967295U));
     strncpy(prompt, "Erase id", (1024));
     break;
    case 'c':
     row = (((4294967295U)) - 1);
     strncpy(prompt, "Erase config", (1024));
     break;
    case 'e':
     row = (((4294967295U)) - 2);
     strncpy(prompt, "Erase EEPROM", (1024));
     break;
    case 'f':
     nrows = (4294967295U);
     strncpy(prompt, "Erase program flash", (1024));
     break;
    default:
     ...
     if (argc == 4) {
      nrows = strtoul(argv[3], ((void *)0), 0);
      if (nrows == 0)
       usage(&k, execname, "Invalid arg [erase]");
     }
     snprintf(prompt, (1024), "Erase %u row(s) at row %u",
      nrows, row);
     break;
    }
 ...
 case 'f': {
   uint32_t words = (4294967295U);
   if (argc > 3)
    usage(&k, execname, "Too many args [program flash]");
   if (argc == 3) {
    words = strtoul(argv[2], ((void *)0), 0);
    if (words == 0)
 ...
 case 'o': if (argc > 3)
   ...
   if (argc == 2)
    ...
    pic_writeosccal(&k, strtoul(argv[2], ((void *)0), 0));
   break;
