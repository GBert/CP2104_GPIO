...
inhx32(struct k8048 *k, const char *filename, uint32_t alignment)
{
 ...
 uint16_t aaaa;
 void *root = ((void *)0);
 inhx32_data *data = ((void *)0);

 k->count = 0;
 k->pdata = ((void *)0);

 if (strcmp(filename, "-") && (f1 = fopen(filename, "rb")) == ((void *)0)) {
 ...
 while (tt != (1) && fgets(line, (1024), f1) != ((void *)0))
 {
  line[((1024) - 1)] = '\0';
  ...
  aaaa = (inhx32_gethexb(&line[(3)]) << 8) | inhx32_gethexb(&line[(3) + 2]);


  tt = inhx32_gethexb(&line[(7)]);
...
# 218 "inhx32.c"
    if (tfind((void *)(data), (void **)(&root), inhx32_compare) != ((void *)0)) {
    ...
    if (tsearch((void *)(data), (void **)(&root), inhx32_compare) == ((void *)0)) {
  ...
  case (4):
    if (aaaa == 0 && bb == 2) {
     extended_address = (inhx32_gethexb(&line[(9)]) << 24) | (inhx32_gethexb(&line[(9) + 2]) << 16);
 ...
 for (uint32_t i = 0; i < k->count; ++i) {
  if (tdelete((void *)(k->pdata[i]), (void **)(&root), inhx32_compare) == ((void *)0)) {
